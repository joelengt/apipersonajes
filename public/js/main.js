...
var _index = require('./renderPersonajes/index');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('./renderDetalles/index');

var _index4 = _interopRequireDefault(_index3);

var _index5 = require('./renderEdit/index');

var _index6 = _interopRequireDefault(_index5);

require('./staticInteraction/btn_publicar');

require('./staticInteraction/like_buttom');

require('./createPersonaje/add_real_time');
...
(0, _page2.default)('/demo', function (ctx, next) {
	$('.Personajes-app__box').find('#From_edit').remove();
	// formlulario_Create.style.display = 'block'
	$.ajax('/api/personajes', {
		success: function success(personajes) {
			$('#pj_item').find('.Personajes-app__read__item').remove();
			$('body').find('.loader').remove();
			(0, _index2.default)(personajes);
		}
	});
});

(0, _page2.default)('/detalle/:id', function (ctx, next) {
	var id = ctx.params.id;
	$.ajax('/api/personajes/' + id, {
		success: function success(personaje) {
			$('#pj_item').find('.Personajes-app__read__item').remove();
			(0, _index4.default)(personaje);
		}
	});
});

(0, _page2.default)('/delete/:id', function (ctx, next) {
	var id = ctx.params.id;
...
(0, _page2.default)('/edit/:id', function (ctx, next) {
	var id = ctx.params.id;
	...
	$.ajax('/api/personajes/' + id, {
		success: function success(personaje) {
			...
			(0, _index6.default)(personaje);
		}
	});
});

(0, _page2.default)('/update/:id', function (ctx, next) {
	var id = ctx.params.id;
...
},{"./createPersonaje/add_real_time":1,"./renderDetalles/index":3,"./renderEdit/index":4,"./renderPersonajes/index":5,"./staticInteraction/btn_publicar":6,"./staticInteraction/like_buttom":7,"page":8}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = renderDetalles;
function renderDetalles(elemento) {
...
exports.default = renderEdit;
function renderEdit(elemento) {
...
exports.default = renderPersonajes;
